...
export const sr: TranslationResource = {
  ui: {
    ...
    max1RarityHero: 'Maksimalno 1 (retkost/heroj)',
    max2Command: 'Maksimalno 2 (komanda)',
    finalRoundMaxTurns: 'Konačna runda! Maksimalno 10 poteza.',
    max5Rounds: 'Maksimalno 5 runda.',
  ...
  rules: {
    ...
    conceptText: '**Žanr i uloga igrača:** New Avalon: Skirmish je dinamička taktička kartaška igra za dva igrača koja se odvija na ograničenom mrežastom polju. Igrači preuzimaju uloge vođa frakcija, raspoređujući Jedinice i Komande kako bi preuzeli kontrolu nad ključnim linijama bojišta.\n\n**Objašnjenje:** Igra se fokusira na pozicionu kontrolu i vreme aktiviranja sposobnosti, a ne samo na direktan napad. Pobeda se postiže ostvarivanjem Poena Za Pobedu (PZP), koji se baziraju na snazi jedinica u izabranim linijama.',
  ...
  counters: {
    Aim: { name: 'Aim', description: 'Ovaj žeton sam po sebi nema efekta, ali može da menja sposobnosti karata.\nOvu kartu je lakše uništiti.' },
    ...
    LastPlayed: { name: 'LastPlayed', description: 'Ova karta je odigrana poslednja od strane svog vlasnika.' },
    Revealed: { name: 'Revealed', description: 'Lice ove karte je vidljivo vlasniku žetona revealed. Može se stavljati na karte u ruci.' },
    Stun: { name: 'Stun', description: 'Oglušena karta ne može da aktivira sposobnosti ili donosi poene. Efekti njenog vlasnika je ne mogu da pomeraju, ali efekti protivnika mogu.\nSkinite 1 žeton oglušenja sa karte posle faze bodovanja (Scoring).' },
    Shield: { name: 'Shield', description: 'Ako efekat pokuša da uništi ovu kartu, umesto toga skinite sa nje 1 žeton štita.' },
    Support: { name: 'Support', description: 'Ovaj žeton sam po sebi nema efekta, ali može da menja sposobnosti karata.\nOva karta se nalazi pored saveznika.' },
    Threat: { name: 'Threat', description: 'Ovaj žeton sam po sebi nema efekta, ali može da menja sposobnosti karata.\nOva karta je okružena i pritisnuta na ivicu polja kartama protivnika.' },
    'Power+': { name: 'Power+', description: 'Povećava snagu karte za 1.' },
    'Power-': { name: 'Power-', description: 'Smanjuje snagu karte za 1.' },
  },
  cards: {},
}
