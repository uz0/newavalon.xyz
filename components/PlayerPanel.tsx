...
// Helper for Square Piles (Deck/Disc/Show) in Remote List Mode
        ...
        return (
            <div className={`w-full h-full flex flex-col p-1 pt-[1px] bg-panel-bg border-2 ${borderClass} rounded-lg shadow-xl ${isDisconnected ? 'opacity-60' : ''} overflow-hidden`}>
                ...
                <div className="flex flex-col flex-1 min-h-0 overflow-hidden">
                    ...
                    {player.hand.length === 0 && <div className="text-center text-gray-600 text-[10px] mt-2 italic">Empty Hand</div>}
                </div>
            </div>
        );
    }
